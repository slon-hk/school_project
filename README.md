...
<h1 class="code-line" data-line-start=22 data-line-end=23 ><a id="_22"></a>Инструкция по запуску программы</h1>
<p class="has-line-data" data-line-start="20" data-line-end="21">
1.Откройте папку “ИИП 10 класс 2024”<br>
2.Откройте папку “Степанов ИИП”<br>
3.Щелкните 2 раза по файлу “ЗАПУСК.exe”<br>
4.Следуйте инструкции в программе.<br>
</p>
